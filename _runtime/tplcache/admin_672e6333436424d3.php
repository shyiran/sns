...
<!--发布样式 begi-->
<div class="contents">
<textarea  name="<?php echo ($contentName); ?>"  cols="" rows="20" id="<?php echo ($contentName); ?>" style="width:<?php echo ($width); ?>; margin-bottom:10px;*width:99%;"><?php echo ($value); ?></textarea>
</div>
<script>
